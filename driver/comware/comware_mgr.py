#!/usr/bin/env python3
"""
A driver to manage HP Comware based elements
"""
...
class Comware_Manager(emmgr.lib.basedriver.BaseDriver):
    ...
    def connect(self):
        ...
        self.em.writeln("mmi-mode enable")
        self.wait_for_prompt()
...
Driver = Comware_Manager


if __name__ == '__main__':
    sys.argv.append("-m comware")
    import emmgr.driver.cli as cli
    cli.main(Comware_Manager)
